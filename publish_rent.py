...
from publish_rent_ss import publish_ss_q, publish_ss_q_house, publish_ss_q_com


def publish_q(scraped, description, driver, to_ssge):
    try:
        # get credentials
        ...
        match scraped["qalaqi"]:
            case "თბილისი":
                driver.execute_script("arguments[0].click();",
                                      wait_until_xpath(30, driver, '//*[@id="0"]/div[6]/div/div/div/div[2]/ul/li[1]'))
            case "ბათუმი":
                driver.execute_script("arguments[0].click();",
                                      wait_until_xpath(30, driver, '//*[@id="0"]/div[6]/div/div/div/div[2]/ul/li[2]'))
            case "ბაკურიანი":
                driver.execute_script("arguments[0].click();",
                                      wait_until_xpath(30, driver, '//*[@id="0"]/div[6]/div/div/div/div[2]/ul/li[8]'))

        field = wait_until_xpath(10, driver, "//label[@for=':ro:']/input")
        ...
        for parameter in scraped["additions"]:
            match parameter:
                ...
                case "loggia":
                    ...
                    loggia = wait_until_xpath(10, driver, '//*[@id="1"]/div[3]/div/div[6]/div/div/label')
        ...
        if driver.find_element(By.TAG_NAME, "circle"):
            ...
            if to_ssge:
                try:
                    publish_ss_q(scraped, description, driver, info_for_database)
                except:
...
def publish_q_house(scraped, description, driver, to_ssge):
    try:
        ...
        bina_gilaki = wait_until_clickable_xpath('//*[@id="0"]/div[2]/div/div/div/div[2]/label', 30, driver)
        bina_gilaki.click()
        ...
        # contact information
        wait_until_xpath(10, driver, '//*[@id=":r1q:"]').send_keys(contact_name)
        wait_until_xpath(10, driver, '//*[@id="3"]/div[2]/div/div[5]/div/div/label').send_keys(Keys.BACKSPACE,
                                                                                                Keys.BACKSPACE,
                                                                                                Keys.BACKSPACE,
                                                                                                Keys.BACKSPACE,
        ...
        if driver.find_element(By.TAG_NAME, "circle"):
            ...
            if to_ssge:
                try:
                    publish_ss_q_house(scraped, description, driver, info_for_database)
                except:
                    info_for_database["SS_LINK"] = "Error SS.GE-ze"
                    to_database(info_for_database)
                    driver.quit()
...
def publish_q_com_area(scraped, description, driver, to_ssge):
    try:
    # get credentials
        with open("config.json", "r", encoding="utf-8") as cfg:
            encoded_config = json.load(cfg)["encoded_data"]
        ...
        wait_until_xpath(10, driver, '//*[@id="0"]/div[3]/div/div/div/div[2]/label').click()
        click('//*[@id="0"]/div[4]/div/div/div/div[2]/label', driver) # gaqiravebis periodi

        click('//*[@id="0"]/div[5]/div/div/div/div', driver) # gaqiravebis tipi mtliani qoneba
        time.sleep(0.05)
        try:
            byxpath("'//*[@id='0']/div[5]/div/div/div/div[2]/ul/li[1]'", driver).click()
        except:
            click('//*[@id="0"]/div[5]/div/div/div/div[2]/ul/li[1]', driver)

        click('//*[@id="0"]/div[6]/div/div/div/div', driver)
        ...
        field = wait_until_xpath(10, driver, "//*[@id='0']/div[7]/div/div[1]/div[2]/label")
        misamarti = scraped["misamarti"]
        try:
            field.send_keys(misamarti)
            listo = wait_until_cs('ul.list-none', 5, driver)
        ...
        wait_until_xpath(10, driver, '//*[@id="1"]/div[2]/div/div[8]/div[1]/div/label').send_keys(scraped["sartuli"])
        wait_until_xpath(10, driver, '//*[@id="1"]/div[2]/div/div[8]/div[2]/div/label').send_keys(
            scraped["sartuli-sul"])
        ###-----#_#_#__##__##__#
        # el = wait_until_xpath(10, driver, '//*[@id="1"]/div[2]/div/div[10]/div/div/div')
        # driver.execute_script("arguments[0].click();", el)
        ...
        # aivnebi tu dafiqsirda chaweros
        if scraped["balconies"] != None:
            wait_until_xpath(10, driver, '//*[@id="1"]/div[2]/div/div[28]/div[1]/div/label').send_keys(
                scraped["balconies"])
            if scraped["balcony_area"] == None or scraped["balcony_area"] == "None":
                wait_until_xpath(10, driver, '//*[@id="1"]/div[2]/div/div[28]/div[2]/div/label').send_keys("1")
            else:
        ...
        # ----------- PARAMETREBIS GILAKEBIS MDEBAREOBEBI
        int_button = wait_until_clickable_xpath('//*[@id="1"]/div[4]/div/div/div/div[1]', 10, driver)
        televizia = wait_until_xpath(10, driver, '//*[@id="1"]/div[4]/div/div/div/div[2]')
        bunebrivi_airi = wait_until_xpath(10, driver, '//*[@id="1"]/div[4]/div/div/div/div[3]')
        lifti = wait_until_xpath(10, driver, '//*[@id="1"]/div[4]/div/div/div/div[4]')
        satvirto_lifti = wait_until_xpath(10, driver, '//*[@id="1"]/div[4]/div/div/div/div[5]')
        ...
        # bejebi
        kari_kodit = wait_until_xpath(10, driver, '//*[@id="1"]/div[7]/div/div/div/div[1]')
        ssmp = wait_until_xpath(10, driver, '//*[@id="1"]/div[7]/div/div/div/div[2]')
        ...
        for parameter in scraped["additions"]:
            match parameter:
                ...
                case "loggia":
                    driver.execute_script("arguments[0].click();", loggia)
                    if scraped["loggia_area"] != None:
                        wait_until_xpath(10, driver, '//*[@id="1"]/div[3]/div/div[6]/div/div/label').send_keys(
                            scraped["loggia_area"])
        ...
        if driver.find_element(By.TAG_NAME, "circle"):
            ...
            if to_ssge == True:
                try:
                    publish_ss_q_com(scraped, description, driver, info_for_database)
                except:
                    info_for_database["SS_LINK"] = "Error SS.GE-ze"
                    to_database(info_for_database)
                    driver.quit()
...
# publish_q_com_area(scraped, "gela", driver=cdriver())